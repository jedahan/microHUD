...
GUIMarineStatus.kBackgroundPos = Vector(30, -60, 0)
...
GUIMarineStatus.kHealthTextPos = Vector(0, 0, 0)
GUIMarineStatus.kArmorTextPos = Vector(60, 0, 0)
...
function GUIMarineStatus:Reset(scale)
    ...
    self.statusbackground:SetColor(Color(0,0,0,0))
